...
<div class="form-check">
 ...
 <div class="form-check form-check-inline">
  ...
  <label class="form-check-label" for="inlineCheckbox1">show my number</label>
</div>
<div class="form-check form-check-inline">
...
<div class="form-check form-check-inline">
  ...
  <label class="form-check-label" for="inlineCheckbox3">Text/sms Ok</label>
</div>
 </div>
 <div>
  ...
  <div class="form-group form-check">
    ...
    <label class="form-check-label" for="exampleCheck1">ok for others to contact you about ervices,products or commercial interests</label>
  </div>
  
<a href="http://localhost:8080/Assessment4/Ad.jsp"> <button type="submit" class="btn btn-dark">continue</a></button> 
